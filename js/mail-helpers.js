...
export function buildEmailFooter(fromEmail) {
...
export function buildEventEmail(event, baseUrl, fromEmail) {
  const evt = event || {};
...
export function buildWelcomeEmail(name, fromEmail) {
