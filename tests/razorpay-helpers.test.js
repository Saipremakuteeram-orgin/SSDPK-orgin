// tests/razorpay-helpers.test.js
...
} from '../js/razorpay-helpers.js';

describe('razorpay helpers', () => {
  it('validateAmount accepts positive integers', () => {
    expect(validateAmount('500')).toBe(500);
    expect(validateAmount(500)).toBe(500);
  });
  it('validateAmount rejects invalid input', () => {
  ...
  it('buildOrderPayload uses INR rupees', () => {
  ...
  it('buildPaymentLinkPayload builds link body', () => {
  ...
  it('mapWebhookToDonation returns null for unhandled events', () => {
    expect(mapWebhookToDonation({ event: 'payment.authorized' })).toBeNull();
  });
});